...
export default function HeroSection({ data }: HeroSectionProps) {
  ...
  return (
    <section className="text-center pt-6 sm:pt-8 md:pt-10 pb-10 md:pb-14 px-4 sm:px-6">
      ...
      {/* Title */}
      <h1 className="text-[32px] sm:text-[42px] lg:text-[56px] font-normal  text-shadow-[0px_4px_4px_rgba(255,_255,_255,_0.1)] mb-4 md:mb-6 font-bebas leading-tight lg:leading-normal">
        {data.hero_title}
      </h1>
