          ...
          <div className="flex gap-4">
            ...
            >
              ...
              <svg width="12" height="24" viewBox="0 0 12 24">
                <path
                  className="fill-black group-hover:fill-[#1e1e1e99] transition"
            ...
            >
              ...
              <svg width="12" height="24" viewBox="0 0 12 24">
                <path
                  className="fill-black group-hover:fill-[#21212199] transition"
            ...
            <div key={i} className="px-4 h-full md:min-h-[354px]">
              <div className="bg-[#4a4a4a] rounded-[5px] sm:p-8.5 p-6 border-r-4 border-b-4 border-white/20 flex flex-col justify-between hover:bg-[#555555] transition h-full">
                <div className='testimonial-top'>
                  ...
                  <h3 className="font-semibold mb-2.5 sm:text-lg text-md text-[#FFFFFFCC]">{t.title}</h3>
                ...
                <div>
                  <p className="font-semibold sm:text-lg text-md text-gray-300">{t.author}</p>
