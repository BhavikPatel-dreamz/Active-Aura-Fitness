  ...
  return (
    <section className="px-4 sm:px-6 pb-16 sm:pb-20">
      ...
      <h3 className="
        ...
        leading-[38px] sm:leading-[48px] lg:leading-[60px]
      ...
      {/* Goals Grid */}
      <div className="grid sm:grid-cols-2 gap-4 sm:gap-[25px] max-w-[619px] mx-auto">
        {goals.map((goal) => {
